...
public interface DbHelper {
    ...
    Observable<List<Schedule>> getScheduleByDirection(long directionId,
                                                      int scheduleType);
    Observable<List<DepartureTime>> getScheduleByStop(long stopId,
                                                      List<Long> directions, int scheduleType);
